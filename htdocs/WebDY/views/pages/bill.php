            ...
            <div class="container sm-margin-top-37px">
                ...
                <?php if(!empty($error)) { ?>
                    ...
                    <?php } elseif (!empty($success)) { ?>
                        <div id="notify-msg"><?=$success?> <a href="../index.php">Tiếp tục mua hàng</a></div>
                    <?php } else {?>
                                        ...
                                        <div class="box-content">
                                            <div class="login-on-checkout">
                                                    ...
                                                    if (isset($_SESSION['user'])) {
                                                        ...
                                                        $phonenum=$_SESSION['user']['phonenum'];
                                                    }else {
                                                        $name="";
                                                        $address="";
                                                        $email="";
                                                    ...
                                                    <p class="form-row">
                                                        ...
                                                        <input type="text" name="name" id="name" value="<?=$name?>" placeholder="Nhập họ và tên đầy đủ" required>
                                                    </p>
                                                    <p class="form-row">
                                                        <label for="input_email">Địa chỉ</label>
                                                        <input type="text" name="address" id="address" value="<?=$address?>" placeholder="Nhập địa chỉ" required>
                                                    </p>
                                                    <p class="form-row">
                                                        <label for="input_email">Email</label>
                                                        <input type="email" name="email" id="email" value="<?=$email?>" placeholder="Nhập email" required>
                                                    </p>
                                                    <p class="form-row">
                                                        <label for="input_email">Điện thoại</label>
                                                        <input type="text" name="phone" id="phone" value="<?=$phonenum?>" placeholder="Nhập số điện thoại" required>
                                                    </p>
                            ...
                            <div class="cart-list-box short-type">
                                ...
                                <?php
                                        ...
                                        if ($statement) {
                                            ...
                                            echo'<span class="number">'.$count.' items</span>';
                                            }}?>  
                                </ul>
                                                ...
                                                <div class="pttt">
                                                    <div class="boxcart">
                                                        <h3>Phương thức thanh toán: </h3> 
                                                            <input type="radio" name="pttt" value="1"  checked>Tiền mặt</br>
                                                            <input type="radio" name="pttt" value="0"  >Chuyển khoản</br>
                                                    </div>
                                                </div>
                                            </li>
                                            </ul>'; ?>
                                <button type="submit" name="thanhtoan" id="payment-button" style="cursor:pointer">Thanh toán</button>
                            </div>
