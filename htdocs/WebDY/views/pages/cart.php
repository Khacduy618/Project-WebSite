                                    ...
                                    <?php
                                        ...
                                        if ($statement) {
                                            ...
                                            <tr class="cart_item">
                                                            ...
                                                            <td class="product-quantity" data-title="Quantity">
                                                                <input type="text" name="soluong['.$MaSP.']"  value="'.$_SESSION['mycart'][$MaSP].'" min="0" max="100" size="1">
                                                            </td>
                                        ...
                                        <tr class="cart_item wrap-buttons">
                                                <td class="wrap-btn-control" colspan="4">
                                                    <a class="btn back-to-shop" href="../index.php?act=product">Cửa hàng</a>
                                                    <button class="btn btn-update" type="submit" name="update_click">Cập nhật</button>
                                    ...
                                    <div class="shpcart-subtotal-block">
                                        ...
                                        ?>
                                         <?php if(isset($_SESSION['user'])){
                                                ...
                                                <a href="../index.php?act=checkout" class="btn checkout">Đặt hàng</a>';
                                            }else{
                                                echo '<div class="btn-checkout">
                                                <a href="../index.php?act=reg" class="btn checkout">Đăng ký để được đặt hàng!</a>';
                                            } ?> 
                                        </div>
