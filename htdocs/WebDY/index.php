<?php
    ...
    include "admin/model/trangthai.php";
            ...
            switch ($act) {
                ...
                case 'reg':
                    if(isset($_POST['dangky'])&&($_POST['dangky']))
                    {
                        ...
                        $pass=$_POST['pass'];
                        $passMd5=md5($pass);
                        $check_user_email=check_reg($user,$email);
                        if($check_user_email){
                            $thongbaoCheck="Địa chỉ Email hoặc Tên đăng nhập tồn tại!";
                        }else{
                            insert_nguoidung($name,$user,$email,$passMd5);
                ...
                case 'checkout':
                    if(isset($_POST['thanhtoan'])){
                        ...
                        }else$MaND=insert_nguoidung_id($name,$user,$email,$pass,$phonenum,$address);
                        $madh="DYcake".$MaND."-".rand(1,1000)."-".date("dmY");
                        ...
                        $id_dh=bill_insert_id($madh, $MaND, $name, $email, $address, $phonenum, $nguoinhan_ten, $nguoinhan_sdt, $nguoinhan_diachi, $tong, $pttt, $id_ttr);
                        $string="";
                        ...
                        break;
                case 'mybill':
                    $listbill=Loadall_bill($_SESSION['user']['MaND']);
                    include "views/pages/mybill.php";
                    break;
                default:
                    include "views/home.php";
                    break;
