<?php
    ...
    function bill_insert_id($madh, $MaND, $name, $email, $address, $phonenum, $nguoinhan_ten, $nguoinhan_sdt, $nguoinhan_diachi, $tong, $pttt, $id_ttr){
        $sql = "INSERT INTO donhang(madh,id_nd,nguoidat_ten,nguoidat_email,nguoidat_diachi,nguoidat_sdt,nguoinhan_ten,nguoinhan_sdt,nguoinhan_diachi,total,pttt,id_ttr) 
                VALUES ('$madh', '$MaND', '$name', '$email', '$address', '$phonenum', '$nguoinhan_ten', '$nguoinhan_sdt', '$nguoinhan_diachi', '$tong', '$pttt', '$id_ttr')";
